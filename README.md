...
- **搜索功能**: Ctrl + K 支持网络搜索及本地书签快捷搜索
- **数据管理**: 支持设置与书签数据的导入导出及扩展自定义设置重置
- **明暗主题/自定义背景**: 明暗主题切换，支持自定义背景
...
插件已经发布在 [edge 扩展商店](https://microsoftedge.microsoft.com/addons/detail/yew-tab/baafmlbflikfncfonojdgilnlcncoljb)，可以从扩展商店安装

> 由于插件会更改新标签页，需要在扩展管理页面手动给予权限
